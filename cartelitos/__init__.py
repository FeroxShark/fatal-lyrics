...
from .lyrics import (
    CACHE_DIR, MAX_INFLIGHT, NONE_TTL, OK_TTL, RETRIES, RETRY_DELAY, RETRY_JITTER,
    ...
    expand_spelled, fetch_lyrics, fetch_lyrics_async, http_json, parse_lrc,
    purge_cache, seg_key, spelled_run, split_repeats, _cache_path, _fetch,
    _fetch_lock, _retry_delay,
)
