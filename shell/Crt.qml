            ...
            Item {
                ...
                Column {
                    ...
                    Repeater {
                        ...
                        WordSlot {
                            id: slot
                            // captura el rol del Repeater ACÁ (mismo truco que
                            // el `required property string modelData` de
                            // antes): `word: modelData` sin este ad hoc
                            // resolvía mal, un `modelData` de un Repeater
                            // ajeno (`Unable to assign QuickshellScreenInfo to
                            // QString` en el log) — WordSlot no tiene una
                            // property literal "modelData" para que el
                            // auto-bind de rol del Repeater enganche directo.
                            required property string modelData
                            word: modelData
